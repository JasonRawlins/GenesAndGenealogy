...
- Create Angular project with ng: `ng new genesandgenealogy.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`genesandgenealogy.client.esproj`).
